...
| `run-public-observation-campaign.py` | controller-run | no `--self-test`; project-local campaign runner | human-readable RunStore, report artifact, and Observatory paths stdout | conforming 0; exceptions fail nonzero | Add offline fixture self-test when runner behavior changes | Next public observation campaign runner change |
| `run-public-observation-lineage-audit.py` | controller-run | no `--self-test`; project-local lineage audit campaign runner | human-readable runGroup, RunStore, Observatory, and partition status stdout | conforming 0; exceptions fail nonzero | Add offline fixture self-test when runner behavior changes | Next public observation lineage audit runner change |
